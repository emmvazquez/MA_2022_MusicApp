...
public class PerfilArtista extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        Button btnCerrar = view.findViewById(R.id.idCerrar2);
        Button btnPaquetes = view.findViewById(R.id.idPaquetes);

        btnPaquetes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_perfilArtista_to_paquetes);
        ...
        btnCerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_perfilArtista_to_bienvenida2);
            }
        });
